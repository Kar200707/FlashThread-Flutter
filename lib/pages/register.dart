...
import 'package:FlashThread/models/register_rturn_data.dart';
                      ...
                      child: SizedBox(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                startLoading();
                                Future<RegisterReturnData> fetchRegister() async {
                                  final response = await http.post(
                                      Uri.parse('https://flashthread.adaptable.app/api/reg'),
                                      body: {
                                  ...
                                  if (response.statusCode == 201) {
                                    ...
                                    final jsonData = RegisterReturnData.fromJson(jsonDataMap);
                                    ...
                                    return RegisterReturnData.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
                                  } else {
                                    stopLoading();
                                    setState(() {
                                      isFalseAuth = true;
